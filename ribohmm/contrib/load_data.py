...
class Transcript():
    ...
    def compute_ORFs_exonic_positions(self):
        """
        For each ORFs, calculate the exonic positions that it occupies
        """
    ...
    def compute_start_stop_pos(self):
        ...
        for orf in self.orfs:
            ...
            # # Before adding placeholder values, record exonic positions
            # orf.exonic_positions = deepcopy(exonic_positions)
